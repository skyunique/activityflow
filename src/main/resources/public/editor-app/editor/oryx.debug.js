...
Clazz.extend = function(def) {
    ...
    //Give this new class the same public extend method
...
ORYX.CONFIG.EVENT_GLOSSARY_LINK_EDIT = 		"glossary.link.editor";
...
//					} else {
				...
				case "Path":
					...
					//use path parser to editor each point of the path
...
//        
//        ORYX.Log.debug("editor.js handles a keyEvent.");
//        
//        // assure we have the current event.
//        if (!event) 
//            event = window.event;
...
//        
//            ORYX.Log.debug("editor.js deletes the shape.");
//            this.editDelete();
//            return;
//        }
//        
